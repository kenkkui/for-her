      ...
      <section className="letter">
        <main className="letter-body">
          ...
          <p>
            ...
            you! UHMM yes happy birthday and eh i hope u get the things u wanna
            get and uh as a friend, i hope you know that your presences’
            meaningful yes.
          </p>
          <p>
            We’ve been friends na for around a month, ata... yet anyways that’s
            no reason i shouldn’t make something for you
          </p>
          <p>
            YK TBH I DONT EVEN KNOW HOW TO MAKE SOME WISH YOU WELL LETTER, i fr
            just sing and gala nlng when theres bday. ISTG IF YOU CRINGE ITS NOT
            MY FAULT
